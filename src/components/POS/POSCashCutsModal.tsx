...
const printPreCutTicket = () => {
    ...
    // Solo se crea y abre la ventana de impresión, eliminando el código de descarga del .txt
    ...
    // El alert se puede mantener para notificar al usuario que el proceso ha iniciado
